"""Navigator patches, UA rotation, and human-like timing for stealth browsing."""
...
def patches() -> list[str]:
    """Return list of JS strings that patch navigator for stealth."""
    return [
        "Object.defineProperty(navigator, 'webdriver', {get: () => undefined})",
        "window.chrome = {runtime: {}, loadTimes: function(){}, csi: function(){}, app: {}}",
        "Object.defineProperty(navigator, 'plugins', {get: () => [1,2,3,4,5]})",
        "Object.defineProperty(navigator, 'mimeTypes', {get: () => [1,2]})",
        """(function(){const originalQuery = window.navigator.permissions.query;
